...
public class HttpHelper {
    ...
    public static String check302(String url) {
        log.info("HTTP请求URL:" + url);
        HttpGet httpGet = new HttpGet(url);
        final String ip = getRandomIp();
        HttpResponse response;
    ...
    public static String postHeaderMethod(String url, Map<String, String> headers, Map<String, Object> param){
        log.info("HTTP请求URL:" + url);
        log.info("HTTP请求参数:" + JSON.toJSONString(param));
        HttpPost httpost = new HttpPost(url);
