...
public class TrxPaymentOrderService1 {
    ...
    @Autowired
    private TrxPaymentOrderService2 trxPaymentOrderService2;
    ...
    public Boolean updatePaymentOrder1(String orderId, String txId, MerchantPaymentOrders merchantPaymentOrders, String address, WithdrawTronDetail withdrawTronDetail, ApiWrapper wrapper) {
        ...
        try {
            ...
            log.info("TRX代付出款 updatePaymentOrder1, 订单号: {}", merchantPaymentOrders.getPlatformOrder());
            ...
            TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
                ...
                public void afterCommit() {
                    ...
                    log.info("TRX代付出款 获取交易记录, 订单号: {}", merchantPaymentOrders.getPlatformOrder());
                    trxPaymentOrderService2.updatePaymentOrder2(orderId, txId, merchantPaymentOrders, address, withdrawTronDetail, wrapper);
                }
            });
        } catch (Exception e) {
            log.error("TRX代付出款失败, e: {}", e);
        }
        return true;
    }
