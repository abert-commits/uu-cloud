 ...
 */
@Data
@ApiModel(description = "collection order list")
public class CollectionOrderExportEnDTO implements Serializable {
     ...
     * 平台订单号
     */
    @ApiModelProperty("buyer order")
    private String platformOrder;

    /**
     * 商户订单号
     */
    @ApiModelProperty("withdraw order")
