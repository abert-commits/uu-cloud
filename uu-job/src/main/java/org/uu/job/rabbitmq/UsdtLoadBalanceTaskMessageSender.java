...
@Service
@Slf4j
public class UsdtLoadBalanceTaskMessageSender {
     ...
     * @param taskInfo
     */
    public void sendUsdtLoadBalanceMessage(TaskInfo taskInfo) {

        String queueName = RabbitMqConstants.UU_WALLET_USDT_COLLECTION_QUEUE;
        ...
        log.info("RabbitMQ发送 USDT资金归集 消息内容: {}, message: {}", message, message);
