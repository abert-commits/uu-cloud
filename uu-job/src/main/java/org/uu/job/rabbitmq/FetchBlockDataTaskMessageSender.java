...
@Service
@Slf4j
public class FetchBlockDataTaskMessageSender {
     ...
     * @param taskInfo
     */
    public void sendFetchBlockDataMessage(TaskInfo taskInfo) {

        String queueName = RabbitMqConstants.UU_WALLET_FETCH_BLOCK_DATA_QUEUE;
        ...
        log.info("RabbitMQ发送 拉取区块数据的MQ 消息内容: {}, message: {}", message, message);
