...
public class ArGenerator{
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://8.222.162.194:3306/uu_wallet?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "UUQevE2@KQo@";
    // @author 值
    private static final String AUTHOR = "";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "org.uu.wallet";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath + "/uu-wallet/src/main/java");
